        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Pendaftaran Kursus UI/UX</h1>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form id="registrationForm" action="{{ route('create') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Jl. Margonda Raya No.8, Pondok Cina, Kecamatan Beji, Kota Depok, Jawa Barat 16422" style="resize: none;" required></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <input type="hidden" value="uiux" name="kursus" id="kursus">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <p>Kursus UI/UX Design ini dirancang untuk pemula maupun desainer berpengalaman yang ingin memperdalam keterampilan dalam menciptakan antarmuka dan pengalaman pengguna yang menarik serta fungsional. Anda akan mempelajari proses desain lengkap, mulai dari riset pengguna hingga pembuatan prototipe interaktif.</p>
                            <p>Fasilitas yang tersedia:</p>
                            <ul>
                                <li>Akses ke tools desain profesional (Figma, Adobe XD, dsb.)</li>
                                <li>Studi kasus nyata & latihan praktis</li>
                                <li>Instruktur berpengalaman di industri UI/UX</li>
